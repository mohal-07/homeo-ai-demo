...
DEBUG = os.environ.get("DEBUG", "0") == "1"  # Only enable if needed
SECRET_KEY = os.environ.get("SECRET_KEY")  # Will set via Sevalla’s dashboard
ALLOWED_HOSTS = ["*"]  # Allow all hosts for demo (replace later)
...
CELERY_RESULT_BACKEND = (
    "redis://localhost:6379/0"  # Optional: If you need task results stored
)
...
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles")  # Often used for deployment
